	...
	(0, _createClass3.default)(Input, [{
		...
		value: function render() {
			...
			var markup = _react2.default.createElement(
				'div',
				{ style: style, className: (0, _classnames2.default)('react-phone-number-input', className, errorStyle) },
...
var _initialiseProps = function _initialiseProps() {
	...
	this.format = function (value) {
		...
		var template = formatter.template;
		var partially_populated_template = formatter.partially_populated_template;
		var country_phone_code = formatter.country_phone_code;
		var national_number = formatter.national_number;
		var national_prefix = formatter.national_prefix;
		var regExp = /[^0-9\+]/ig;
		if (template && partially_populated_template && partially_populated_template.replace(regExp, '') !== national_number && national_prefix !== '0') {
			text = formatter.parsed_input;
		}
		...
		if (event.target.value && event.target.value[0] !== '+') {
			var _event = (0, _extends3.default)({}, event, {
				target: (0, _extends3.default)({}, event.target, {
					value: '+' + (0, _libphonenumberJs.getPhoneCode)(country_code) + event.target.value
				})
