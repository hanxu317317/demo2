...
exports.calculateOutOfParent = exports.calculateSelfPosition = exports.calculatePortalPosition = exports.getPosition = undefined;
...
var getPosition = exports.getPosition = function getPosition(target) {
    if (target) {
        return (0, _dom.getDomOffset)(target);
    }
};
...
var calculatePortalPosition = exports.calculatePortalPosition = function calculatePortalPosition(direction, targetInfo, dropdown, offset) {
    var result = {};
...
var calculateSelfPosition = exports.calculateSelfPosition = function calculateSelfPosition(direction, targetInfo, dropdown) {
    var result = {};
 ...
 * @return {[type]}          [description]
 */
var calculateOutOfParent = exports.calculateOutOfParent = function calculateOutOfParent(children, container) {
    var parent = {};

    if (!container) {
        var result = (0, _dom.getWindowsSize)();
        parent = {
            x1: 0, y1: 0,
    ...
    var checkIn = function checkIn(x, y, wrap) {
    ...
    for (var i = 0; i < 4; i++) {
        var flag = checkIn(children['x' + (i + 1)], children['y' + (i + 1)], parent);
